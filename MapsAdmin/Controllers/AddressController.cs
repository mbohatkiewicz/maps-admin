...
namespace MapsAdmin.Controllers
{
    ...
    public class AddressController : Controller
    {
        ...
        public ActionResult Details(int profileId, [Bind(Prefix="id")] int addressId)
        {
            if (addressId == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            Address address = db.Addresses.Include("Profile").FirstOrDefault(a => a.AddressId == addressId);
            if (address == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Delete(int profileId, [Bind(Prefix = "id")] int addressId)
        {
            if (addressId == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int profileId, [Bind(Prefix = "id")] int addressId)
        {
            Address address = db.Addresses.Include("Profile").FirstOrDefault(a => a.AddressId == addressId);
